...
public class SendMessageToAllCommand implements Command {
    ...
    public SendMessageToAllCommand(CompetitorRepository compatitorRepository, UserRepository userRepository, MessageService messageService) {
        this.competitorRepository = compatitorRepository;
    ...
    public SendMessage apply(Update update) {
        ...
        if(currentUser.getUserStatus().equals((UserStatus.ADMIN)))
        {
            ...
            state.setCurrentCommandType(ActiveCommandType.MESSAGE_TO_ALL);
